        ...
        <div class="form">
            <div class="p-5" style="width: 100%;">
                ...
                <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                    ...
                    <?= $form->field($model, 'both')->textInput([
                        'placeholder' => "Enter your login or email", 'autofocus' => true, // test qilish kk
                        ...
                        <?= $form->field($model, 'password')->passwordInput(['placeholder' => " Password", 'autofocus' => true, // test qilish kk
                        'class' => 'form-control mb-4']) ?>
