...
<head>
   ...
   <meta name="desc" content="Biz haqimizda">
      ...
      <header class="py-5 relative flex-center">
            ...
            <div class="relative text-center">
               ...
               <div class="social text-center size18">
                  <a class="facebook" href="#" target="_blank">
                        <i class="ion-social-facebook"></i><div class="title">FACEBOOK</div>
                  </a>
                  <a class="instagram" href="#" target="_blank">
                        <i class="ion-social-instagram"></i><div class="title">INSTAGRAM</div>
                  </a>
                  <a class="youtube" href="#" target="_blank">
                        <i class="ion-social-youtube"></i><div class="title">YOUTUBE</div>
                  </a>
               </div>
            </div>
         </div>
        ...
        <div class="content relative">
            ...
            <div class="aboutPage pt-5">
               <div class="container py-5" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate consequatur voluptatibus culpa a odit debitis minus, nihil laudantium ex dolore alias laboriosam accusamus illum in assumenda doloremque blanditiis vero recusandae?
               </div>
            </div>
