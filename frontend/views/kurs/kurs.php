         ...
         <div class="container py-5">
            <div class="relative text-center">
               <div class="size48 semibold mb-3 title-slide-in" data-splitting>
                  ...
                  <?= $kurs->title ?>
                  <div class="pt-3">
                     <a href="<?=Url::to(['/student/signup', 'kurs_id' => $id])?>" class="myBtn blue">Ro'yxatdan o'tish</a>
                  </div>
         ...
         <div class="coursePage pt-5">
            <div class="container py-5">
               <div class="paragraph pb-3 text-center" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                  <div class="size48 title wow fadeInUp">Kurs haqida</div>
               </div>
               <div class="mt-3"><?= $kurs->batafsil ?></div>
               ...
               <div class="paragraph mt-5 pt-5 pb-4 text-center" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                  <div class="size48 title wow fadeInUp">Kurs rejasi</div>
               </div>
               <?php foreach ($kurs_rejasi as $kr) : ?>
                  <div class="py-1" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                     <div class="accordion size20 bold"><i class="ion-chevron-down"></i> <?= $kr->title ?></div>
                     <div class="content"><?= $kr->batafsil ?></div>
                  </div>
               <?php endforeach ?>

               <div class="paragraph mt-5 pt-5 pb-4 text-center" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                  <div class="size48 title wow fadeInUp">Sizdan nima talab qilinadi?</div>
               </div>
               <div class="row mt-3 text-center">
                  <div class="col-12 col-sm-6 col-lg-4 py-2">
                     <div class="info p-3" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                        <div class="size18 semibold"><i class="ion-checkmark-round color"></i> Shaxsiy noutbook</div>
                     </div>
                  </div>
                  <!--  -->
                  <div class="col-12 col-sm-6 col-lg-4 py-2">
                     <div class="info p-3" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                        <div class="size18 semibold"><i class="ion-checkmark-round color"></i> Kuchli ishtiyoq</div>
                     </div>
                  </div>
                  <!--  -->
                  <div class="col-12 col-sm-6 col-lg-4 py-2">
                     <div class="info p-3" data-bottom-top="transform:translate(0,120px) scale(0.7)" data-bottom-bottom="transform:translate(0,0px) scale(1);">
                        <div class="size18 semibold"><i class="ion-checkmark-round color"></i> Kompyuter savodxonligi</div>
                     </div>
                  </div>
               </div>
